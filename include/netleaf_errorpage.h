...
#define NL_ERRORPAGE_VERSION_MAJOR 2
#define NL_ERRORPAGE_VERSION_MINOR 2
#define NL_ERRORPAGE_VERSION_PATCH 1

// =========================================
// Module Information
// =========================================

// ErrorPage module capabilities
#define NL_ERRORPAGE_CAPABILITIES \
    (NL_CAP_THREAD_SAFE | NL_CAP_PLATFORM_ALL)

// ErrorPage module info structure (defined in implementation)
NL_ERRORPAGE_API nl_module_info_t* nl_errorpage_get_module_info(void);

// ErrorPage extension entry point (for dynamic loading)
NL_ERRORPAGE_API nl_extension_info_t* nl_errorpage_get_extension_info(void);
