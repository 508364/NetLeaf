# NetLeaf v2.1.6 - 高级服务器API

## 🚀 新功能概述

NetLeaf v2.1.6 带来了强大的高级服务器API，支持：
...
- **v2.1.6**: 新增编码动态适配、自动编码协商、双向转码、控制台编码支持
- **v2.1.5**: 新增系统信息组件、全局懒加载、模块启停、多线程优化
- **v2.1.0**: 简化服务器启动、自动清理、多服务器管理、异步并发优化
